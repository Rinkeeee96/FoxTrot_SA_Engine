...
LevelBuilder::LevelBuilder(Engine& _engine, int levelId, int _startingTileId) : AbstractLevelBuilder(_engine), bLevel(new Level(levelId, 0, 0)), textureId{_startingTileId} {
