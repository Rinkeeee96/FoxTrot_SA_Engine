...
void ChapterThreeScene::onAttach()
{
	loadButtons();
	loadText();
	loadBackground();
...
void ChapterThreeScene::loadText() {
	this->setTextFromFile("Assets/Levels/Story/ChapterThree.txt", 4);
...
void ChapterThreeScene::loadBackground() {
...
void ChapterThreeScene::loadMusic() {
	engine->loadSound("BACKGROUND", "Assets/Sound/TremLoadingloopl.wav");
}

/// @brief 
/// Create the sounds for this scene
void ChapterThreeScene::start(bool playSound)
{
...
void ChapterThreeScene::onDetach()
{
